...
INSERT INTO Daytrip VALUES('Dagsferð til Vestmannaeyja','2023-04-01','08:00:00','21:00:00','Allt landið tók andköf þegar heimaeyjargosið hófst. Enda er það líklegast það sem Heimaey er frægust fyrir, það eða þjóðhátíð. Núna bjóðum við upp á að kíkja í dagsferð til Heimaey. Þar er hægt að skoða bæjinn, fara í sund, labba í náttúrunni, kíkja í Herjólfsdal, og auðvitað smakka það sem heimamenn hafa upp á að bjóða. Það verður leiðsögumaður, en það er afar líklegt að hópurinn muni skiptast upp yfir daginn. Sniðugt að klæðast eftir veðri, taka með sér sundföt og smá nesti, og mjög mikilvægt að hafa á hreinu hvenær skipið kemur og fer.',23999,12,'Suður');
...
INSERT INTO Daytrip VALUES('Skotsvæði','2023-04-01','08:00:00','16:00:00','Á íslandi eru um það bil þrjátíu byssur fyrir hverja hundruð íbúa, sem kemur kannski á óvart því Ísland er afar friðsælt land. Við höfum þó afar gaman af byssum, og því eru skotsvæði allstaðar um landið. Í þessari ferð verður farið með rútu að skotsvæði út á landi og eytt nokkrum tímum þar. Hægt er að skjóta með boga og allskyns riflum, og þar verður sérfræðingur sem getur kennt að miða betur. Börn yngri en 15 eru ekki leyfð.',8999,12,'Norðaustur');
