...
public class Daytrip extends DaytripController {
    ...
    public Daytrip(String dTitle1, LocalDate date1, LocalTime start_time1, LocalTime end_time1, String description1, int price1, String photo1, int available_seats1, String location1, String reviews, int rating) {
        this.dTitle = dTitle1;
        this.date = date1;
